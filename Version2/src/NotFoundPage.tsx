        ...
        <div className="home-container relative min-h-full flex flex-col items-center justify-center p-4">
            ...
            <div className="text-center space-y-8 animate-fade-in relative z-10 max-w-lg mx-auto">
                <div className="relative inline-block">
                    ...
                    <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-7xl sm:text-9xl font-black text-gray-800/5 select-none">
                        404
                    </h1>
                </div>

                <div className="space-y-4">
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-red-50 text-red-600 border border-red-100 text-[10px] font-bold uppercase tracking-widest">
                        Protocol Error
                    </div>
