    ...
    return (
        <BentoCard className="col-span-12 sm:col-span-6 md:col-span-3 row-span-2 flex flex-col" ghostChar="C" delay={500}>
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-black text-gray-900 tracking-tight">Coding DNA</h3>
                <Link
                    to="/coding-profiles"
            ...
            <div className="flex flex-col gap-4 justify-between flex-1">
                {top3.map((profile, i) => {
                    ...
                    return (
                        ...
                        >
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 text-lg font-black ${colors.bg} ${colors.text} border ${colors.border}`}>
                                {profile.label[0]}
                            </div>
                            <div className="flex-1 min-w-0">
                                <h4 className="text-[15px] font-bold text-gray-900 mb-0.5">{profile.label}</h4>
