      ...
      <table class="w-full border-collapse text-sm">
        <thead>
          <tr class="bg-gray-100">
            <th class="border border-gray-300 px-4 py-2 text-left font-semibold">Attack Type</th>
            <th class="border border-gray-300 px-4 py-2 text-left font-semibold">Vector</th>
            <th class="border border-gray-300 px-4 py-2 text-left font-semibold">Goal</th>
            <th class="border border-gray-300 px-4 py-2 text-left font-semibold">Severity</th>
          </tr>
        </thead>
        <tbody>
          <tr>
